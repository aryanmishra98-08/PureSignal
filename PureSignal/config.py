...
EMA_ALPHA = 0.25  # centroid update rate
# (higher = adapts faster to same-speaker variation)
MAX_SPEAKERS = 4
...
# --- Internal numeric constants (replaces magic numbers in sub-modules) ---
NORM_FLOOR = 1e-6  # minimum L2 norm before treating a vector as zero
NOISE_FLOOR_EMA_FAST = 0.05  # VAD noise floor EMA weight for the current frame
NOISE_FLOOR_EMA_SLOW = 0.95  # VAD noise floor EMA weight for history
MIN_SEGMENT_S = 0.5  # minimum segment length in seconds for encoder.embed()
